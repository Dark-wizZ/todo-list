...
/* harmony import */ var _img_starGold_png__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../img/starGold.png */ "./src/img/starGold.png");
...
class Content{
  ...
  static contentRender(){
    this.contentHeading.textContent = _project__WEBPACK_IMPORTED_MODULE_5__["default"].currentProject;
    this.tasksRender();
  }
  static tasksRender(){
    this.tasks.innerHTML='';
    for(let i=0; i<_todos__WEBPACK_IMPORTED_MODULE_1__["default"].todoList.length; i++){
      if(_todos__WEBPACK_IMPORTED_MODULE_1__["default"].todoList[i].project != _project__WEBPACK_IMPORTED_MODULE_5__["default"].currentProject){
        continue;
      }
      //create dom element
  ...
  static checkBoxChange(e){
    const index = _ui__WEBPACK_IMPORTED_MODULE_6__["default"].indexByElem(e);
    if(e.checked){
  ...
  static taskIPStarIconClk(){
    if(this.taskIPStarIcon.src == _img_starGold_png__WEBPACK_IMPORTED_MODULE_4__){
      this.taskIPStarIcon.src = _img_star_png__WEBPACK_IMPORTED_MODULE_3__;
    }else{
      this.taskIPStarIcon.src=_img_starGold_png__WEBPACK_IMPORTED_MODULE_4__;
    }
  }
  ...
  static confirmBtnClk(){
    ...
    const task = new _task__WEBPACK_IMPORTED_MODULE_0__["default"](
      (this.taskTitleIP.value)?(this.taskTitleIP.value):'Title Undefined',
       this.dueDateIP.value, _project__WEBPACK_IMPORTED_MODULE_5__["default"].currentProject
    );
    if(this.taskIPStarIcon.src==_img_starGold_png__WEBPACK_IMPORTED_MODULE_4__){
      task.priority=true;
    }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (class{
  ...
  static deleteProject(ind){
    _todos__WEBPACK_IMPORTED_MODULE_0__["default"].todoList = _todos__WEBPACK_IMPORTED_MODULE_0__["default"].todoList.filter((task)=>{
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (class{
  ...
  static projectRender(){
    ...
    for(let i=0; i<_project__WEBPACK_IMPORTED_MODULE_0__["default"].projectList.length; i++){
      ...
      if(_project__WEBPACK_IMPORTED_MODULE_0__["default"].projectList[i]==_project__WEBPACK_IMPORTED_MODULE_0__["default"].currentProject){
        projectItem.classList.add('current');
      }
      projectItem.setAttribute('data-index',i);
      projectItem.textContent = _project__WEBPACK_IMPORTED_MODULE_0__["default"].projectList[i];
  ...
  static trashIconClk(e){
    ...
    const index = _ui__WEBPACK_IMPORTED_MODULE_2__["default"].indexByElem(e);
    _project__WEBPACK_IMPORTED_MODULE_0__["default"].deleteProject(index);
    this.render();
  }
  ...
  static projectTickClk(){
    ...
    if(_project__WEBPACK_IMPORTED_MODULE_0__["default"].projectList.includes(this.titleIP.value)){
      this.titleExistError.style.display='block';
      return;
    }

    _project__WEBPACK_IMPORTED_MODULE_0__["default"].addProjectToList(this.titleIP.value);
  ...
  static projectItemClk(e){
    ...
    _project__WEBPACK_IMPORTED_MODULE_0__["default"].currentProject = e.textContent;
    _ui__WEBPACK_IMPORTED_MODULE_2__["default"].render();
  }
  static resetInput(){
    this.titleIP .value= '';
...
class UI{
  static init(){
    ...
    if(_index__WEBPACK_IMPORTED_MODULE_4__.storageAvailability){
      _project__WEBPACK_IMPORTED_MODULE_2__["default"].projectList = (_index__WEBPACK_IMPORTED_MODULE_4__.storage.projectList) ?
      JSON.parse(_index__WEBPACK_IMPORTED_MODULE_4__.storage.projectList): _project__WEBPACK_IMPORTED_MODULE_2__["default"].projectList;
      _todos__WEBPACK_IMPORTED_MODULE_3__["default"].todoList = (_index__WEBPACK_IMPORTED_MODULE_4__.storage.todoList) ?
      JSON.parse(_index__WEBPACK_IMPORTED_MODULE_4__.storage.todoList): _todos__WEBPACK_IMPORTED_MODULE_3__["default"].todoList;
    }
  ...
  static render(){
    ...
    if(_index__WEBPACK_IMPORTED_MODULE_4__.storageAvailability){
      _index__WEBPACK_IMPORTED_MODULE_4__.storage.projectList = JSON.stringify(_project__WEBPACK_IMPORTED_MODULE_2__["default"].projectList);
      _index__WEBPACK_IMPORTED_MODULE_4__.storage.todoList = JSON.stringify(_todos__WEBPACK_IMPORTED_MODULE_3__["default"].todoList);
    }
  }
